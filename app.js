...
var topLeft = metronome.append('g')
  ...
  .attr('transform', `translate(${extraWidth + dialRadius * 0.2}, ${extraHeight + dialRadius * 0.2})`)
...
var topRight = metronome.append('g')
  .attr('transform', `translate(${window.innerWidth - extraWidth - dialRadius * 0.2}, ${extraHeight + dialRadius * 0.2})`)
...
var bottomLeft = metronome.append('g')
  ...
  .attr('transform', `translate(${extraWidth + dialRadius * 0.2}, ${window.innerHeight - extraHeight - dialRadius * 0.2})`)
...
var bottomRight = metronome.append('g')
  ...
  .attr('transform', `translate(${window.innerWidth - extraWidth - dialRadius * 0.2}, ${window.innerHeight - extraHeight - dialRadius * 0.2})`)
